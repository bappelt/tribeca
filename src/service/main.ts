...
import Cryptsy = require("./gateways/cryptsy");
...
var liveTradingSetup = () => {
    ...
    var getExchange = (): Models.Exchange => {
        ...
        switch (ex) {
            ...
            case "cryptsy": return Models.Exchange.Cryptsy;
    ...
    var getExch = (orderCache: Broker.OrderStateCache): Interfaces.CombinedGateway => {
        switch (exchange) {
            ...
            case Models.Exchange.Cryptsy: return <Interfaces.CombinedGateway>(new Cryptsy.Cryptsy(config));
