...
var OrderListController = ($scope: OrderListScope,
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [
            ...
            { width: 75, field: 'price', displayName: 'px', cellFilter: 'currency:"":8' },
            ...
            { width: 75, field: 'lastPrice', displayName: 'lPx', cellFilter: 'currency:"":8' },
            { width: 60, field: 'leavesQuantity', displayName: 'lvQty' },
            { width: 60, field: 'cumQuantity', displayName: 'cum' },
            { width: 75, field: 'averagePrice', displayName: 'avg', cellFilter: 'currency:"":8' },
