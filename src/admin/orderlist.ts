...
var OrderListController = ($scope: OrderListScope,
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [
            ...
            { width: 65, field: 'price', displayName: 'px', cellFilter: 'currency:"":4' },
            ...
            { width: 65, field: 'lastPrice', displayName: 'lPx', cellFilter: 'currency:"":4' },
            { width: 60, field: 'leavesQuantity', displayName: 'lvQty' },
            { width: 60, field: 'cumQuantity', displayName: 'cum' },
            { width: 65, field: 'averagePrice', displayName: 'avg', cellFilter: 'currency:"":4' },
